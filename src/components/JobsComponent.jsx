...
export const JobsComponent = () => {
    ...
    return (
        <section id="experience" className="section-jobs">
            ...
            <div className="flex-1 ml-2 h-px bg-slate-600"></div>
            ...
            <div className="w-full">
                <div className="max-w-5xl mx-auto py-7">
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="w-full md:w-48 border-l-0 md:border-l-2 border-t-2 md:border-t-0 border-slate-600 mb-6 md:mb-0 md:mr-8">
                            {jobs.map((job, index) => (
                                <button
                                    key={index}
                                    ...
                                    ${index === activeCompany 
                                        ? 'text-indigo-400-300 border-l-0 md:border-l-2 border-t-2 md:border-t-0 text-violet-400 -ml-0 md:-ml-[2px] bg-slate-800/50' 
                        ...
                        <div className="flex-1">
                            <h3 className="text-2xl text-slate-200">
                                {currentJob.title}{' '}
                                <span className="x">@ {currentJob.company}</span>
                            </h3>
                            <p className="job-period font-mono mb-8">{currentJob.period}</p>
